...
// 👇 No Props
export default function OpeningCountSlide() {
    ...
    return (
        <StoryCard id="slide-repertoire" className={CONTAINERS.slideCard}>
            ...
            <motion.div className={CONTAINERS.slideContainer} variants={containerVariants} initial="hidden" animate="visible">
                <StoryHeader icon={<Shield size={24}/>} iconColor="text-[#81b64c]" title={total.toString()} subtitle="Unique Variants Played" />
                <motion.div variants={itemVariants} className="w-full h-[180px] relative mb-4 z-10">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            <Pie data={chartData} dataKey="value" cx="50%" cy="50%" innerRadius={50} outerRadius={75} stroke="#262421" strokeWidth={3} paddingAngle={2}>
