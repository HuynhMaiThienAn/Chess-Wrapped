...
export default function HomePage() {
  return (
    <>
          ...
          <div className="bg-white rounded-[2.5rem] sm:rounded-[3rem] p-2 sm:p-3 border-4 border-white/20">
            <div className="bg-[#302e2b] rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 text-center relative overflow-hidden border-4 border-[#302e2b]">
              ...
              <div className="mb-6 sm:mb-8 relative z-10">
                <div className="inline-flex items-center gap-2 bg-[#ffc800] text-[#302e2b] px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-bold text-xs sm:text-sm shadow-sm mb-3 sm:mb-4 animate-bounce">
                ...
                <p className="text-[#989795] text-base sm:text-lg font-medium">
              ...
              <div className="relative z-10 space-y-4">
                <div className="bg-[#262421] rounded-3xl p-2 border-4 border-[#3e3c39]">
                  <Input
                    className="w-full bg-transparent border-none text-center text-xl sm:text-2xl font-bold text-white focus:outline-none placeholder:text-[#3e3c39] py-2 sm:py-3 px-2"
                    placeholder="username"
                  />
                </div>

                <div className="flex flex-col sm:flex-row gap-2">
                  <select className="flex-1 bg-[#262421] border-4 border-[#3e3c39] text-white rounded-2xl p-3 text-base sm:text-lg font-semibold">
                    <option value="chesscom">Chess.com</option>
                    <option value="lichess">Lichess</option>
                  </select>

                  <Button className="bg-[#81b64c] hover:bg-[#72a341] text-white text-base sm:text-lg font-bold px-6 py-3 rounded-2xl p-5 shadow-[0_6px_0_#457524] active:shadow-none active:translate-y-[6px] transition-all flex items-center justify-center gap-2 border-2 border-[#81b64c]">
      ...
      <section
        className="bg-[#262421] text-white flex items-center justify-center text-center text-balance flex-col gap-8 px-4 font-bubbly border-t-10 border-b-10">
        <div className="container flex flex-col px-4 py-16 md:px-16">
          <h2 className="text-5xl lg:text-6xl xl:text-7xl font-bold">
            ChessWrap Stats
          </h2>

          <div className="px-4 sm:px-16 gap-10 sm:gap-10 text-center flex flex-col sm:flex-row justify-center items-center">
            <div className="text-2xl py-10 md:py-10 lg:text-4xl xl:text-6xl">
            ...
            <div className="text-2xl py-10 md:py-20 lg:text-4xl xl:text-6xl">
      ...
      <section
        className="bg-transparent relative overflow-hidden flex items-center justify-center text-center text-balance flex-col font-bubbly selection:bg-white selection:text-[#81b64c] py-16">

        <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold z-40 px-4 text-white">
          Our Community
        </h2>
      ...
      <footer className="w-full border-t-10 border-b-10 bg-[#262421] font-bubbly">
        <div className="container mx-auto flex gap-10 px-6 py-12 md:flex-row md:justify-between md:gap-20">
          <div className="flex flex-col gap-4 md:max-w-xs">
            ...
            <p className="text-sm text-white text-muted-foreground">
              Capture your best chess moments :D
            </p>
          </div>
